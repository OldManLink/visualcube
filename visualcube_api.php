...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	...
	<body>
		...
		<div id="content_v">
			<h2>Instructions</h2>
			Simply point your browser to cube.arcanel.se to create a cube image.<br/>
			A range of parameters can be set to customise the cube visualisation.<br/>
			Click the link below for an example:<br/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="/?fmt=<?php echo $DEFAULTS['fmt']; ?>&size=300&amp;pzl=3&amp;alg=y2RUR'U'">cube.arcanel.se?fmt=<?php echo $DEFAULTS['fmt']; ?>&size=300&amp;pzl=3&amp;alg=y2RUR'U'</a>
			<br/><br/><br/>
			<h2>Examples</h2>
